...
- [x] 5 pts Technology: Toasts / global notifications or alerts
- [x] 5 pts Technology: Error handling (both on api requests and render errors)
- [x] 5 pts Technology: Network Calls that read and write data
- [x] 5 pts Technology: Developer type helping (typescript)
- [x] 5 pts Technology: 10+ pages or views
...
- [x] 9 pts Technology: 3+ generic form input components
- [x] 12 pts Technology: 4+ generic layout components
- [x] 10 pts Technology: authentication and user account support
- [x] 5 pts Technology: authorized pages and public pages
- [x] 5 pts Experience: all experiences mobile friendly
- [x] 5 pts Experience: 3 instances where elements re-order themselves on smaller screens
- [x] 20 pts Professional, organized and smooth experience
